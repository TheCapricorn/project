...
import {Button, Form, Select, Divider, Input, Table, Modal, Badge, Alert} from 'antd'
      ...
      render: (text, record) => {
        return (
          <div className={'table-opt-btns'}>
            ...
            <LinkButton type='modify' data={record} callback={this.loadTable}/>
          </div>
        )
      }
    }];
